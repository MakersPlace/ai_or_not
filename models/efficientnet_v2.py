...
def EfficientNetV2(
    ...
    # Create model.
    # genreating random model name by getting current time and appending it to model name
    random_name = model_name + str(datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
    model = training.Model(inputs, x, name=random_name)
